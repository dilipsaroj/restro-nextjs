...
export default function LoginModal({ isSignin }: { isSignin: boolean }) {
  ...
  useEffect(() => {
    if (isSignin) {
      ...
      if (inputs.firstName && inputs.lastName && inputs.city && inputs.password && inputs.email && inputs.phone) {
        return setDisabled(false)
      }
    }
        ...
        <Box sx={style}>
          {
            loading ?
              (
                <div className='py-24 px-2 h-[600] flex justify-center'>
                  <CircularProgress />
                </div>
              ...
              (<div className='p-2 h-[600px]'>
                ...
                <div className='m-auto'>
                  ...
                  <LoginInput inputs={inputs} handleChange={handleChange} isSignin={isSignin} />
